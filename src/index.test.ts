...
import { greet, isOld, countOdd, sumEven, getPersonStreetNo, Person, Address, PersonClass, EmployeeClass, IPerson, getPersonNameString, printThis, optionallyAdd, greetPeople, addToStart, Wrapper } from './index';
